...
describe("web-ui - Acceptance Tests", () => {
  test("AC-1: bun add vee-validate @vee-validate/zod vue-sonner executed in apps/web and packages saved to package.json", async () => {
    const pkgPath = import.meta.dir + "/../../../apps/web/package.json";
    const pkgFile = Bun.file(pkgPath);
    const pkg = await pkgFile.json() as { dependencies?: Record<string, string> };
    const deps = pkg.dependencies ?? {};
    expect(deps["vee-validate"]).toBeDefined();
    expect(deps["@vee-validate/zod"]).toBeDefined();
    expect(deps["vue-sonner"]).toBeDefined();
  });
  ...
  test("AC-2: All required Shadcn components installed via bunx shadcn-vue@latest add: button card badge dialog input textarea select label form table separator avatar sonner dropdown-menu", async () => {
    const uiDir = import.meta.dir + "/../../../apps/web/components/ui";
    const requiredComponents = [
      "button", "card", "badge", "dialog", "input", "textarea",
      "select", "label", "form", "table", "separator", "avatar",
      "sonner", "dropdown-menu",
    ];
    for (const component of requiredComponents) {
      const componentDir = Bun.file(uiDir + "/" + component + "/.keep");
      const dirPath = uiDir + "/" + component;
      // Check directory exists by checking for any file in it
      const glob = new Bun.Glob("*");
      const files = await Array.fromAsync(glob.scan({ cwd: dirPath, onlyFiles: false }));
  ...
  test("AC-12: layouts/default.vue created with fixed sidebar (w-56), nav links (Dashboard, Projects), bottom user section", async () => {
  ...
  test("AC-13: Top header renders dark mode toggle button using useColorMode() — sun/moon icon swap", async () => {
    // TODO: Implement acceptance test for AC-13
    // Top header renders dark mode toggle button using useColorMode() — sun/moon icon swap
    expect(true).toBe(false); // Replace with actual test
  });

  test("AC-14: Dark mode toggle correctly switches class-based dark mode via colorMode.preference", async () => {
  ...
  test("AC-15: Sidebar shows current user name from useAuth().user", async () => {
    // TODO: Implement acceptance test for AC-15
    // Sidebar shows current user name from useAuth().user
    expect(true).toBe(false); // Replace with actual test
  });

  test("AC-16: Logout button in sidebar/header calls useAuth().logout()", async () => {
    // TODO: Implement acceptance test for AC-16
    // Logout button in sidebar/header calls useAuth().logout()
    expect(true).toBe(false); // Replace with actual test
  });

  test("AC-17: Mobile sidebar toggles visibility via v-show and a local ref, not CSS media breakpoints", async () => {
  ...
  test("AC-18: pages/index.vue updated with definePageMeta({ layout: 'default' })", async () => {
    // TODO: Implement acceptance test for AC-18
    // pages/index.vue updated with definePageMeta({ layout: 'default' })
    expect(true).toBe(false); // Replace with actual test
  });

  test("AC-19: app.vue updated to not duplicate navigation (renders NuxtPage inside NuxtLayout)", async () => {
    // TODO: Implement acceptance test for AC-19
    // app.vue updated to not duplicate navigation (renders NuxtPage inside NuxtLayout)
    expect(true).toBe(false); // Replace with actual test
  });

  test("AC-20: bun run lint passes with 0 errors", async () => {
    // TODO: Implement acceptance test for AC-20
    // bun run lint passes with 0 errors
    expect(true).toBe(false); // Replace with actual test
  });

  test("AC-21: bun run type-check passes", async () => {
    // TODO: Implement acceptance test for AC-21
    // bun run type-check passes
    expect(true).toBe(false); // Replace with actual test
  });

  test("AC-22: pages/index.vue fetches GET /projects via useApi() with useAsyncData", async () => {
    // TODO: Implement acceptance test for AC-22
    // pages/index.vue fetches GET /projects via useApi() with useAsyncData
    expect(true).toBe(false); // Replace with actual test
  });

  test("AC-23: Projects rendered as Card grid (1/2/3 columns responsive) with name, key Badge, truncated description", async () => {
  ...
  test("AC-24: 'View Board' button on each card navigates to /${project.slug}", async () => {
    // TODO: Implement acceptance test for AC-24
    // 'View Board' button on each card navigates to /${project.slug}
    expect(true).toBe(false); // Replace with actual test
  });

  test("AC-25: 'New Project' button opens CreateProjectDialog", async () => {
    // TODO: Implement acceptance test for AC-25
    // 'New Project' button opens CreateProjectDialog
    expect(true).toBe(false); // Replace with actual test
  });

  test("AC-26: CreateProjectDialog has name, slug, key fields with VeeValidate+Zod validation", async () => {
    // TODO: Implement acceptance test for AC-26
    // CreateProjectDialog has name, slug, key fields with VeeValidate+Zod validation
    expect(true).toBe(false); // Replace with actual test
  });

  test("AC-27: Slug auto-derives from name input: lowercase, spaces to hyphens, non-alphanumeric stripped", async () => {
  ...
  test("AC-28: Key field auto-uppercases and validates /^[A-Z]+$/, min 2 max 6 chars", async () => {
    // TODO: Implement acceptance test for AC-28
    // Key field auto-uppercases and validates /^[A-Z]+$/, min 2 max 6 chars
    expect(true).toBe(false); // Replace with actual test
  });

  test("AC-29: Successful create: toast.success, emits 'created', list refreshes", async () => {
    // TODO: Implement acceptance test for AC-29
    // Successful create: toast.success, emits 'created', list refreshes
    expect(true).toBe(false); // Replace with actual test
  });

  test("AC-30: Failed create: toast.error with message", async () => {
    // TODO: Implement acceptance test for AC-30
    // Failed create: toast.error with message
    expect(true).toBe(false); // Replace with actual test
  });

  test("AC-31: Empty state rendered when projects array is empty", async () => {
    // TODO: Implement acceptance test for AC-31
    // Empty state rendered when projects array is empty
    expect(true).toBe(false); // Replace with actual test
  });

  test("AC-32: bun run lint passes with 0 errors", async () => {
    // TODO: Implement acceptance test for AC-32
    // bun run lint passes with 0 errors
    expect(true).toBe(false); // Replace with actual test
  });

  test("AC-33: bun run type-check passes", async () => {
    // TODO: Implement acceptance test for AC-33
    // bun run type-check passes
    expect(true).toBe(false); // Replace with actual test
  });

  test("AC-34: pages/[project]/index.vue reads slug from route params and fetches correct tickets endpoint", async () => {
  ...
  test("AC-35: TicketBoard renders 6 columns in order: CREATED, VERIFIED, IN_PROGRESS, VERIFY_FIX, CLOSED, REJECTED", async () => {
  ...
  test("AC-36: Each column shows correct ticket count badge", async () => {
    // TODO: Implement acceptance test for AC-36
    // Each column shows correct ticket count badge
    expect(true).toBe(false); // Replace with actual test
  });

  test("AC-37: Tickets are grouped by status and each renders as TicketCard in its column", async () => {
    // TODO: Implement acceptance test for AC-37
    // Tickets are grouped by status and each renders as TicketCard in its column
    expect(true).toBe(false); // Replace with actual test
  });

  test("AC-38: TicketCard shows ref (mono font), title, type Badge with correct border color, priority Badge with correct variant", async () => {
  ...
  test("AC-39: TicketCard click emits 'open' and page navigates to /${slug}/tickets/${ref}", async () => {
    // TODO: Implement acceptance test for AC-39
    // TicketCard click emits 'open' and page navigates to /${slug}/tickets/${ref}
    expect(true).toBe(false); // Replace with actual test
  });

  test("AC-40: Assignee Avatar shown when ticket has assignee", async () => {
    // TODO: Implement acceptance test for AC-40
    // Assignee Avatar shown when ticket has assignee
    expect(true).toBe(false); // Replace with actual test
  });

  test("AC-41: 'New Ticket' button in CREATED column opens CreateTicketDialog", async () => {
    // TODO: Implement acceptance test for AC-41
    // 'New Ticket' button in CREATED column opens CreateTicketDialog
    expect(true).toBe(false); // Replace with actual test
  });

  test("AC-42: CreateTicketDialog form has title, type, priority (default MEDIUM), description fields with VeeValidate+Zod", async () => {
  ...
  test("AC-43: Successful ticket creation shows toast and refreshes board data", async () => {
    // TODO: Implement acceptance test for AC-43
    // Successful ticket creation shows toast and refreshes board data
    expect(true).toBe(false); // Replace with actual test
  });

  test("AC-44: Board uses horizontal scroll for columns on narrow viewports", async () => {
    // TODO: Implement acceptance test for AC-44
    // Board uses horizontal scroll for columns on narrow viewports
    expect(true).toBe(false); // Replace with actual test
  });

  test("AC-45: bun run lint passes with 0 errors", async () => {
    // TODO: Implement acceptance test for AC-45
    // bun run lint passes with 0 errors
    expect(true).toBe(false); // Replace with actual test
  });

  test("AC-46: bun run type-check passes", async () => {
    // TODO: Implement acceptance test for AC-46
    // bun run type-check passes
    expect(true).toBe(false); // Replace with actual test
  });

  test("AC-47: pages/[project]/tickets/[ref].vue two-column layout renders ticket data from API", async () => {
    // TODO: Implement acceptance test for AC-47
    // pages/[project]/tickets/[ref].vue two-column layout renders ticket data from API
    expect(true).toBe(false); // Replace with actual test
  });

  test("AC-48: Title, description (pre-wrap whitespace), status/priority/type badges all display correctly", async () => {
  ...
  test("AC-49: TicketActionPanel shows Verify and Reject buttons for CREATED status", async () => {
    // TODO: Implement acceptance test for AC-49
    // TicketActionPanel shows Verify and Reject buttons for CREATED status
    expect(true).toBe(false); // Replace with actual test
  });

  test("AC-50: TicketActionPanel shows Start button for VERIFIED status", async () => {
    // TODO: Implement acceptance test for AC-50
    // TicketActionPanel shows Start button for VERIFIED status
    expect(true).toBe(false); // Replace with actual test
  });

  test("AC-51: TicketActionPanel shows Submit Fix and Reject buttons for IN_PROGRESS status", async () => {
    // TODO: Implement acceptance test for AC-51
    // TicketActionPanel shows Submit Fix and Reject buttons for IN_PROGRESS status
    expect(true).toBe(false); // Replace with actual test
  });

  test("AC-52: TicketActionPanel shows Approve Fix and Fail Fix buttons for VERIFY_FIX status", async () => {
    // TODO: Implement acceptance test for AC-52
    // TicketActionPanel shows Approve Fix and Fail Fix buttons for VERIFY_FIX status
    expect(true).toBe(false); // Replace with actual test
  });

  test("AC-53: TicketActionPanel shows no action buttons for CLOSED or REJECTED status", async () => {
    // TODO: Implement acceptance test for AC-53
    // TicketActionPanel shows no action buttons for CLOSED or REJECTED status
    expect(true).toBe(false); // Replace with actual test
  });

  test("AC-54: Actions requiring comment (Verify, Reject, Submit Fix, Fail Fix) open a Dialog with Textarea before API call", async () => {
  ...
  test("AC-55: Successful transition shows toast and refreshes ticket data", async () => {
    // TODO: Implement acceptance test for AC-55
    // Successful transition shows toast and refreshes ticket data
    expect(true).toBe(false); // Replace with actual test
  });

  test("AC-56: CommentThread renders comments in chronological order", async () => {
    // TODO: Implement acceptance test for AC-56
    // CommentThread renders comments in chronological order
    expect(true).toBe(false); // Replace with actual test
  });

  test("AC-57: Each comment shows type as colored pill (VERIFICATION=blue, FIX_REPORT=orange, REVIEW=green, GENERAL=gray)", async () => {
  ...
  test("AC-58: Add comment form has body (required) and type select, submits to correct endpoint", async () => {
    // TODO: Implement acceptance test for AC-58
    // Add comment form has body (required) and type select, submits to correct endpoint
    expect(true).toBe(false); // Replace with actual test
  });

  test("AC-59: New comment appends without full page reload", async () => {
    // TODO: Implement acceptance test for AC-59
    // New comment appends without full page reload
    expect(true).toBe(false); // Replace with actual test
  });

  test("AC-60: bun run lint passes with 0 errors", async () => {
    // TODO: Implement acceptance test for AC-60
    // bun run lint passes with 0 errors
    expect(true).toBe(false); // Replace with actual test
  });

  test("AC-61: bun run type-check passes", async () => {
    // TODO: Implement acceptance test for AC-61
    // bun run type-check passes
    expect(true).toBe(false); // Replace with actual test
  });

  test("AC-62: pages/[project]/agents.vue fetches GET /agents and renders in Table", async () => {
    // TODO: Implement acceptance test for AC-62
    // pages/[project]/agents.vue fetches GET /agents and renders in Table
    expect(true).toBe(false); // Replace with actual test
  });

  test("AC-63: Each row shows Name, Slug, Roles as Badge list, Capabilities as Badge list, Status badge, Actions dropdown", async () => {
  ...
  test("AC-74: bun run type-check exits 0 with no TypeScript errors", async () => {
    // TODO: Implement acceptance test for AC-74
    // bun run type-check exits 0 with no TypeScript errors
    expect(true).toBe(false); // Replace with actual test
  });

  test("AC-75: bun run build exits 0 and output contains Build complete", async () => {
    // TODO: Implement acceptance test for AC-75
    // bun run build exits 0 and output contains Build complete
    expect(true).toBe(false); // Replace with actual test
  });

  test("AC-76: No @ts-ignore comments in any new file under apps/web (except generated/)", async () => {
    // TODO: Implement acceptance test for AC-76
    // No @ts-ignore comments in any new file under apps/web (except generated/)
    expect(true).toBe(false); // Replace with actual test
  });

  test("AC-77: No hardcoded Tailwind color classes (text-gray-*, bg-gray-*) in new files — Shadcn CSS variables used instead", async () => {
  ...
  test("AC-78: components/ui/ directory contains all 13 required component groups: button card badge dialog input textarea select label form table separator avatar sonner dropdown-menu", async () => {
  ...
  test("AC-79: All imports resolve correctly — no missing module errors", async () => {
