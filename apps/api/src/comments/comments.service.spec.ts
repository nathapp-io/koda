...
describe('CommentsService', () => {
  ...
  describe('create', () => {
    ...
    it('should create a comment with type stored correctly', async () => {
      ...
      mockPrismaService.comment.create.mockResolvedValue(commentWithType);
  ...
  describe('update', () => {
    ...
    it('should allow author (agent) to edit own comment', async () => {
      ...
      mockPrismaService.comment.findUnique.mockResolvedValue(agentComment);
      mockPrismaService.comment.update.mockResolvedValue({
        ...agentComment,
        body: 'Updated by agent',
      });
    ...
    it('should preserve comment type when updating body', async () => {
      ...
      mockPrismaService.comment.findUnique.mockResolvedValue(verificationComment);
      mockPrismaService.comment.update.mockResolvedValue({
        ...verificationComment,
        body: 'Updated body only',
      });
  ...
  describe('delete', () => {
    ...
    it('should allow author (agent) to delete own comment', async () => {
      const agentComment = { ...mockComment, authorUserId: null, authorAgentId: 'agent-123' };
      mockPrismaService.comment.findUnique.mockResolvedValue(agentComment);
      mockPrismaService.comment.delete.mockResolvedValue(agentComment);
